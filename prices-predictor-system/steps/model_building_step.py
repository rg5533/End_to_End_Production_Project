...
def model_building_step(
    ...
    numerical_transformer = SimpleImputer(strategy="mean") # to be on the safe side, in case we end up creating nan values IN THE DATASET
    # Since we did not do any encoding in feature engineering, we will implement it in here.
